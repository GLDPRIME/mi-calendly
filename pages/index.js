...
// ── Estilos ───────────────────────────────────────────────────────────────────
const s = {
  page: { minHeight:'100vh', display:'flex', alignItems:'flex-start', justifyContent:'center', padding:'12px 8px', background:'var(--bg)' },
  card: { display:'flex', flexDirection:'column', background:'var(--surface)', borderRadius:'var(--radius-lg)', border:'1px solid var(--border)', overflow:'hidden', width:'100%', maxWidth:820, boxShadow:'0 4px 24px rgba(0,0,0,0.06)' },
  sidebar: { width:'100%', borderBottom:'1px solid var(--border)', borderRight:'none', padding:'20px', display:'flex', flexDirection:'row', flexWrap:'wrap', alignItems:'center', gap:10 },
  avatar: { width:44, height:44, borderRadius:'50%', background:'#e8f0fe', display:'flex', alignItems:'center', justifyContent:'center', fontSize:16, fontWeight:600, color:'#2a5bd7', flexShrink:0 },
  hostName: { fontSize:12, color:'var(--text-muted)', marginTop:2 },
  meetingTitle: { fontSize:14, fontWeight:600, color:'var(--text)', marginTop:0 },
  ...
  stepHeader: { padding:'16px', borderBottom:'1px solid var(--border)' },
  stepTitle: { fontSize:15, fontWeight:600 },
  stepSub: { fontSize:13, color:'var(--text-muted)', marginTop:3 },
  calNav: { display:'flex', alignItems:'center', justifyContent:'space-between', padding:'16px 16px 8px' },
  ...
  calGrid: { display:'grid', gridTemplateColumns:'repeat(7,1fr)', gap:2, padding:'0 16px 12px' },
  ...
  btnRow: { padding:'16px', borderTop:'1px solid var(--border)', display:'flex', justifyContent:'flex-end', gap:10, marginTop:'auto' },
  ...
  formArea: { flex:1, padding:'16px', display:'flex', flexDirection:'column', gap:14 },
  ...
  confirmWrap: { flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:14, padding:'24px 16px', textAlign:'center' },
